...
const Login: React.FunctionComponent<ILoginProps> = (props) => {
  ...
  return(
    ...
    <Card.Body>
      ...
      <button type="submit" className="btn btn-primary" style={{backgroundColor:'#fc562b'}}>Login</button>  
      <p style={{color:'blue'}}><Link to="/Register">Don't Have an Account? Click Here to register</Link></p>
    </Form>
